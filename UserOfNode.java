...
public class UserOfNode {
  ...
  public static void main(String[] commandLine) {
    System.out.println( System.lineSeparator() + "Test Node");
    ...
    System.out.println( noNext + System.lineSeparator());
    ...
    System.out.println( nextSet + System.lineSeparator());

    // 2-arg constructor obviates setReferenceToNextNode
    System.out.println("2-arg constructor obviates setReferenceToNextNode");
